<!-- Footer -->
            ...
            <div class="container mx-auto px-4">
                <div class="flex flex-col md:flex-row justify-between items-center">
                    ...
                    <div class="flex space-x-4 md:space-x-6">
                        <!-- Facebook Icon -->
                        <a href="https://www.facebook.com/share/1P4si4SRJ5/" class="text-white hover:text-cyan-400 transition-colors" aria-label="Facebook">
                        ...
                        <!-- Instagram Icon -->
                        <a href="https://www.instagram.com/byteverse1.0?igsh=cDduZDB0bTVhZmU4" class="text-white hover:text-cyan-400 transition-colors" aria-label="Instagram">
                            <svg class="h-5 w-5 md:h-6 md:w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        ...
                        <!-- WhatsApp Icon -->
                        <!-- <a href="#" class="text-white hover:text-cyan-400 transition-colors" aria-label="WhatsApp">
                            <svg class="h-5 w-5 md:h-6 md:w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        ...
                        <!-- LinkedIn Icon -->
                        <a href="https://www.linkedin.com/company/ct-group-of-institutions/posts/?feedView=all" class="text-white hover:text-cyan-400 transition-colors" aria-label="LinkedIn">
                            <svg class="h-5 w-5 md:h-6 md:w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <div class="border-t border-gray-800 mt-6 md:mt-8 pt-6 md:pt-8 flex flex-col md:flex-row justify-between items-center">
                    <div class="text-white text-xs md:text-sm mb-4 md:mb-0 text-center md:text-left">
                        © 2025 ByteVerse by CTGroup. All rights reserved.
                    </div>
                    
                    <div class="flex space-x-4 md:space-x-6 text-xs md:text-sm">
                        <a href="contact.php" class="text-white hover:text-cyan-400">Contact</a>
                    </div>
                </div>
            </div>
        </footer>
    ...
    <!-- Shader scripts and audio files remain unchanged -->
